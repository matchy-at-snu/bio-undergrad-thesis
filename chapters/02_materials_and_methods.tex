...
\begin{figpage}
  \begin{figure}[tb]
    ...
    \captionof{figure}{Visualizaiton of k-mer table and ID table sizes when $k = 11$.
  ...
  \begin{figure}
    ...
    \captionof{figure}{The example decoding process of difference index $2039432531946$.
...
\begin{figpage}
  ...
  \begin{figure}[htbp]
    ...
    \caption{Part of the ASCII table, showing the bit representation of \texttt{A} to \texttt{Z} with the last 5 bits highlighted.
