...
Speed is the first and foremost concern of \texttt{Petasearch}. The speed of \texttt{Petasearch} prototype is already fast, but did not make it stand out too much from its competitors. In this section, we will introduce several techniques to further boost the speed of \texttt{Petasearch}.
